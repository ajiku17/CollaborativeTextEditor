...
func NewDocumentUpdateManager(serverUrl string) *DocumentUpdateManager {
	for {
		...
		return &DocumentUpdateManager{serverUrl, socket}
	}
}
...
func (manager *DocumentUpdateManager)sendRequest(data []byte, actionName string){
